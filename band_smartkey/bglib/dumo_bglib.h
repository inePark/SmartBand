...
#define	dumo_cmd_hardware_read_write_spi_id                         	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_cmd|0x0A0C0000)
...
#define	dumo_rsp_hardware_read_write_spi_id                         	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_rsp|0x0A0C0000)
...
/**This command can be used to set the Bluetooth connection local role. Note that this may not be possible if the remote device is the master and does not 
            allow role changes.**/
...
/**This command can be used to read from and write to the specified SPI interface. The SPI interfaces must be configured in the hardware.xml file, as described in the module Configuration Guide.**/
...
bglib_temp_msg.header=(((uint32)dumo_msg_type_cmd|dumo_dev_type_dumo|(((uint32)6+bglib_temp_msg.cmd_hardware_read_write_spi.data.len)>>8)))|((((uint32)6+bglib_temp_msg.cmd_hardware_read_write_spi.data.len)&0xff)<<8)|((uint32)0xc<<16)|((uint32)0xa<<24);\
